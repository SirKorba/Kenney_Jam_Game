...
#func _on_Person1_Area_mouse_entered():
	...
	#current_person = $Persons/Person1
#
...
#func _on_Person2_Area_mouse_entered():
	...
	#current_person = $Persons/Person2
#
...
#func _on_Person3_Area_mouse_exited():
	#current_person = null
#
#func _on_person_3_area_mouse_shape_entered(shape_idx):
	#show_hint("Person3_Area")
	#current_person = $Persons/Person3
...
func _on_person_1_area_entered(area):
	check_match("Person1", area.name)

func _on_person_2_area_entered(area):
	check_match("Person2", area.name)

func _on_person_3_area_entered(area):
	check_match("Person3", area.name)
